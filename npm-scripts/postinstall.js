...
stat('lib', function(error, stat) {
    if (error || !stat.isDirectory()) {
        console.warn(
            ...
            'Frequency Meter from GitHub. React Frequency Meter sources need to be transpiled before use. We\n' +
        ...
        try {
            ...
            console.error(
                '-'.repeat(79) + '\n' +
                'Failed to build React Frequency Meter automatically. Please install React Frequency Meter from\n' +
